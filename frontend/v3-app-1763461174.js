    ...
    async exportToNews() {
        ...
        try {
            ...
            if (window.app.handleAudioUpload) {
                showNotification('Uploading MP3...', 'info');
                ...
                // Reload the news editor to show updated info
                if (window.app.openNews && window.app.currentNews) {
                    await window.app.openNews(window.app.currentNews.id);
                }
                
                showNotification('Audio exported to news as MP3 (192kbps)!', 'success');
                console.log('✅ Audio exported to news as MP3 (192kbps)');
            } else {
