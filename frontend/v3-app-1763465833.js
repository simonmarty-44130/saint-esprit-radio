...
class SaintEspritV3 {
    ...
    async saveNews() {
        ...
        // Calculate duration (seul le contenu compte, pas lancement/pied qui sont des notes présentateur)
        if (this.durationManager) {
...
${news.content || 'Pas de contenu'}
    ...
    async saveAnimation() {
        ...
        // Calculate duration (seul le contenu compte, pas lancement/pied qui sont des notes présentateur)
        if (this.durationManager) {
            const durations = this.durationManager.calculateTotalDuration(this.currentAnimation.content);
